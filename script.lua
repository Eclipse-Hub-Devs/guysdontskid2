-- ===== BANANA KAITUN UI (TRon Void Ez) =====
task.spawn(function()
    local BLighting = game:GetService("Lighting")
    local Bblur = Instance.new("BlurEffect")
    Bblur.Name = "TRonVoidBlur"
    Bblur.Size = 0
    Bblur.Parent = BLighting

    local CoinCard = Instance.new("ScreenGui")
    local DropShadowHolder = Instance.new("Frame")
    local BMain = Instance.new("Frame")
    local BUICorner = Instance.new("UICorner")
    local BUIStroke = Instance.new("UIStroke")
    local BDivider1 = Instance.new("Frame")
    local BDivider2 = Instance.new("Frame")
    local TypeAccountScroll = Instance.new("Frame")
    local BItemLabel1 = Instance.new("TextLabel")
    local BItemLabel2 = Instance.new("TextLabel")
    local BItemLabel3 = Instance.new("TextLabel")
    local BBeliLabel = Instance.new("TextLabel")
    local BLevelLabel = Instance.new("TextLabel")
    local BRaceLabel = Instance.new("TextLabel")
    local BTL1 = Instance.new("TextLabel")
    local BTL2 = Instance.new("TextLabel")
    local BTL3 = Instance.new("TextLabel")
    local BTL4 = Instance.new("TextLabel")
    local BTL5 = Instance.new("TextLabel")
    local BTL6 = Instance.new("TextLabel")
    local BTL7 = Instance.new("TextLabel")
    local BTop = Instance.new("TextLabel")
    local BUIGrad1 = Instance.new("UIGradient")
    local BUnder1 = Instance.new("TextLabel")
    local BUIGrad2 = Instance.new("UIGradient")
    local BUnder2 = Instance.new("TextLabel")
    local BUIGrad3 = Instance.new("UIGradient")
    local BDropShadow = Instance.new("ImageLabel")

    local PURPLE_NEON = Color3.fromRGB(160, 0, 255)
    local PURPLE_DARK = Color3.fromRGB(90, 0, 180)

    CoinCard.Name = "TRonVoidCard"
    ...
    BMain.AnchorPoint = Vector2.new(0.5, 0.5)
    BMain.BackgroundColor3 = Color3.fromRGB(8, 2, 22)
    BMain.BackgroundTransparency = 0.15
    BMain.Name = "Main"
    BMain.Parent = DropShadowHolder
    BMain.Position = UDim2.new(0.5, 0, 0.5, 0)
    BMain.Size = UDim2.new(1, -47, 1, -47)

    BUICorner.CornerRadius = UDim.new(0, 12)
    BUICorner.Parent = BMain

    BUIStroke.Color = PURPLE_NEON
    BUIStroke.Thickness = 2.5
    BUIStroke.Parent = BMain

    BDivider1.Name = "Divider"
    BDivider1.BackgroundColor3 = PURPLE_DARK
    BDivider1.Parent = BMain
    BDivider1.Position = UDim2.new(0.15, 0, 0.15, 0)
    BDivider1.Size = UDim2.new(0.7, 0, 0, 2)

    BDivider2.Name = "Divider"
    BDivider2.BackgroundColor3 = PURPLE_DARK
    BDivider2.Parent = BMain
    BDivider2.Position = UDim2.new(0.1, 0, 0.75, 0)
    BDivider2.Size = UDim2.new(0.8, 0, 0, 2)

    TypeAccountScroll.BackgroundTransparency = 1
    TypeAccountScroll.Name = "TypeAccountScroll"
    TypeAccountScroll.Parent = BMain
    TypeAccountScroll.Position = UDim2.new(0.55, 0, 0.35, 0)
    TypeAccountScroll.Size = UDim2.new(0.4, 0, 0.35, 0)

    BItemLabel1.BackgroundTransparency = 1
    BItemLabel1.Parent = TypeAccountScroll
    BItemLabel1.Size = UDim2.new(1, 0, 0, 18)
    BItemLabel1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BItemLabel1.Text = "Item 1"
    BItemLabel1.TextColor3 = Color3.fromRGB(255, 255, 255)
    BItemLabel1.TextSize = 16

    BItemLabel2.BackgroundTransparency = 1
    BItemLabel2.Parent = TypeAccountScroll
    BItemLabel2.Position = UDim2.new(0, 0, 0, 20)
    BItemLabel2.Size = UDim2.new(1, 0, 0, 18)
    BItemLabel2.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BItemLabel2.Text = "Item 2"
    BItemLabel2.TextColor3 = Color3.fromRGB(255, 255, 255)
    BItemLabel2.TextSize = 16

    BItemLabel3.BackgroundTransparency = 1
    BItemLabel3.Parent = TypeAccountScroll
    BItemLabel3.Position = UDim2.new(0, 0, 0, 40)
    BItemLabel3.Size = UDim2.new(1, 0, 0, 18)
    BItemLabel3.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BItemLabel3.Text = "Item 3"
    BItemLabel3.TextColor3 = Color3.fromRGB(255, 255, 255)
    BItemLabel3.TextSize = 16

    BBeliLabel.BackgroundTransparency = 1
    BBeliLabel.Name = "BeliLabel"
    BBeliLabel.Parent = BMain
    BBeliLabel.Position = UDim2.new(0.07, 0, 0.55, 0)
    BBeliLabel.Size = UDim2.new(0.4, 0, 0, 18)
    BBeliLabel.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BBeliLabel.Text = "Beli: N/A"
    BBeliLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    BBeliLabel.TextSize = 16
    BBeliLabel.TextXAlignment = Enum.TextXAlignment.Left
    BBeliLabel.TextYAlignment = Enum.TextYAlignment.Bottom

    BLevelLabel.BackgroundTransparency = 1
    BLevelLabel.Name = "LevelLabel"
    BLevelLabel.Parent = BMain
    BLevelLabel.Position = UDim2.new(0.07, 0, 0.35, 0)
    BLevelLabel.Size = UDim2.new(0.44, 0, 0, 18)
    BLevelLabel.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BLevelLabel.Text = "Level: N/A    Third Sea : ❌"
    BLevelLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    BLevelLabel.TextSize = 16
    BLevelLabel.TextXAlignment = Enum.TextXAlignment.Left
    BLevelLabel.TextYAlignment = Enum.TextYAlignment.Bottom

    BRaceLabel.BackgroundTransparency = 1
    BRaceLabel.Name = "RaceLabel"
    BRaceLabel.Parent = BMain
    BRaceLabel.Position = UDim2.new(0.07, 0, 0.45, 0)
    BRaceLabel.Size = UDim2.new(0.4, 0, 0, 18)
    BRaceLabel.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BRaceLabel.Text = "Race: N/A"
    BRaceLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    BRaceLabel.TextSize = 16
    BRaceLabel.TextXAlignment = Enum.TextXAlignment.Left
    BRaceLabel.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL1.BackgroundTransparency = 1
    BTL1.Parent = BMain
    BTL1.Position = UDim2.new(0.07, 0, 0.8, 0)
    BTL1.Size = UDim2.new(0.3, 0, 0, 18)
    BTL1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL1.Text = "🟣 GodHuman"
    BTL1.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL1.TextSize = 16
    BTL1.TextXAlignment = Enum.TextXAlignment.Left
    BTL1.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL2.BackgroundTransparency = 1
    BTL2.Parent = BMain
    BTL2.Position = UDim2.new(0.75, 0, 0.9, 0)
    BTL2.Size = UDim2.new(0.25, 0, 0, 18)
    BTL2.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL2.Text = "🟣 Pull Lever"
    BTL2.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL2.TextSize = 16
    BTL2.TextXAlignment = Enum.TextXAlignment.Left
    BTL2.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL3.BackgroundTransparency = 1
    BTL3.Parent = BMain
    BTL3.Position = UDim2.new(0.75, 0, 0.8, 0)
    BTL3.Size = UDim2.new(0.25, 0, 0, 18)
    BTL3.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL3.Text = "🟣 Valkyrie Helm"
    BTL3.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL3.TextSize = 16
    BTL3.TextXAlignment = Enum.TextXAlignment.Left
    BTL3.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL4.BackgroundTransparency = 1
    BTL4.Parent = BMain
    BTL4.Position = UDim2.new(0.4, 0, 0.9, 0)
    BTL4.Size = UDim2.new(0.3, 0, 0, 18)
    BTL4.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL4.Text = "🟣 Mirror Fractal"
    BTL4.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL4.TextSize = 16
    BTL4.TextXAlignment = Enum.TextXAlignment.Left
    BTL4.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL5.BackgroundTransparency = 1
    BTL5.Parent = BMain
    BTL5.Position = UDim2.new(0.07, 0, 0.9, 0)
    BTL5.Size = UDim2.new(0.3, 0, 0, 18)
    BTL5.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL5.Text = "🟣 Skull Guitar"
    BTL5.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL5.TextSize = 16
    BTL5.TextXAlignment = Enum.TextXAlignment.Left
    BTL5.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL6.BackgroundTransparency = 1
    BTL6.Parent = BMain
    BTL6.Position = UDim2.new(0.07, 0, 0.65, 0)
    BTL6.Size = UDim2.new(0.2, 0, 0, 18)
    BTL6.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL6.Text = "Frag: N/A"
    BTL6.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL6.TextSize = 16
    BTL6.TextXAlignment = Enum.TextXAlignment.Left
    BTL6.TextYAlignment = Enum.TextYAlignment.Bottom

    BTL7.BackgroundTransparency = 1
    BTL7.Parent = BMain
    BTL7.Position = UDim2.new(0.4, 0, 0.8, 0)
    BTL7.Size = UDim2.new(0.3, 0, 0, 18)
    BTL7.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTL7.Text = "🟣 Cursed Dual Katana"
    BTL7.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTL7.TextSize = 16
    BTL7.TextXAlignment = Enum.TextXAlignment.Left
    BTL7.TextYAlignment = Enum.TextYAlignment.Bottom

    BTop.BackgroundTransparency = 0.999
    BTop.Name = "Top"
    BTop.Parent = BMain
    BTop.Position = UDim2.new(0.5, 0, 0.05, 0)
    BTop.Size = UDim2.new(0.6, 0, 0, 18)
    BTop.AnchorPoint = Vector2.new(0.5, 0)
    BTop.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BTop.Text = "TRon Void Ez Kaitun"
    BTop.TextColor3 = Color3.fromRGB(255, 255, 255)
    BTop.TextSize = 16
    BTop.TextYAlignment = Enum.TextYAlignment.Bottom

    BUIGrad1.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(160, 0, 255)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 0, 180))
    }
    BUIGrad1.Parent = BTop

    BUnder1.BackgroundTransparency = 0.999
    BUnder1.Name = "Under"
    BUnder1.Parent = BMain
    BUnder1.Position = UDim2.new(0.2, 0, 0.25, 0)
    BUnder1.Size = UDim2.new(0.3, 0, 0, 18)
    BUnder1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BUnder1.Text = "Account Stats"
    BUnder1.TextColor3 = Color3.fromRGB(255, 255, 255)
    BUnder1.TextSize = 16
    BUnder1.TextYAlignment = Enum.TextYAlignment.Bottom

    BUIGrad2.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(160, 0, 255)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 0, 180))
    }
    BUIGrad2.Parent = BUnder1

    BUnder2.BackgroundTransparency = 0.999
    BUnder2.Name = "Under2"
    BUnder2.Parent = BMain
    BUnder2.Position = UDim2.new(0.75, 0, 0.25, 0)
    BUnder2.Size = UDim2.new(0.25, 0, 0, 18)
    BUnder2.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
    BUnder2.Text = "Account Items"
    BUnder2.TextColor3 = Color3.fromRGB(255, 255, 255)
    BUnder2.TextSize = 16
    BUnder2.TextYAlignment = Enum.TextYAlignment.Bottom

    BUIGrad3.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(160, 0, 255)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 0, 180))
    }
    BUIGrad3.Parent = BUnder2

    BDropShadow.AnchorPoint = Vector2.new(0.5, 0.5)
    BDropShadow.BackgroundTransparency = 1
    BDropShadow.Name = "DropShadow"
    BDropShadow.Parent = DropShadowHolder
    BDropShadow.Position = UDim2.new(0.5, 0, 0.5, 0)
    BDropShadow.Size = UDim2.new(1, 47, 1, 47)
    BDropShadow.ZIndex = 0
    BDropShadow.Image = "rbxassetid://6015897843"
    BDropShadow.ImageTransparency = 0.25
    BDropShadow.ImageColor3 = Color3.fromRGB(60, 0, 120)
    ...
    local BStatusHolder = Instance.new("Frame")
    BStatusHolder.Name = "StatusHolder"
    BStatusHolder.Parent = BStatus
    BStatusHolder.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    BShadow2.AnchorPoint = Vector2.new(0.5, 0.5)
    BShadow2.BackgroundTransparency = 1
    BShadow2.BorderSizePixel = 0
    BShadow2.Position = UDim2.new(0.5, 0, 0.35, 0)
    BShadow2.Size = UDim2.new(1, 47, 1, 47)
    BShadow2.ZIndex = 0
    BShadow2.Image = "rbxassetid://6015897843"
    BShadow2.ImageColor3 = Color3.fromRGB(0, 0, 0)
    BShadow2.ImageTransparency = 0.5
    BShadow2.ScaleType = Enum.ScaleType.Slice
    BShadow2.SliceCenter = Rect.new(49, 49, 450, 450)

    local BStatusMain = Instance.new("Frame")
    BStatusMain.Parent = BShadow2
    BStatusMain.AnchorPoint = Vector2.new(0.5, 0.5)
    BStatusMain.BackgroundColor3 = Color3.fromRGB(8, 2, 22)
    ...
    BStatusStroke.Color = Color3.fromRGB(160, 0, 255)
    BStatusStroke.Thickness = 2.5

    local BStatusCorner = Instance.new("UICorner")
    BStatusCorner.CornerRadius = UDim.new(0, 8)
    BStatusCorner.Parent = BStatusMain

    local BStatusTop = Instance.new("TextLabel")
    ...
    BToggleGui.Name = "TRonVoidToggle"
    BToggleGui.Parent = game:GetService("CoreGui")
    BToggleGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    BToggleGui.DisplayOrder = 10

    local BToggleFrame = Instance.new("Frame")
    BToggleFrame.Name = "ToggleFrame"
    BToggleFrame.Parent = BToggleGui
    BToggleFrame.AnchorPoint = Vector2.new(0.1, 0.1)
    BToggleFrame.BackgroundColor3 = Color3.fromRGB(30, 5, 60)
    BToggleFrame.Position = UDim2.new(0, 20, 0.1, -6)
    BToggleFrame.Size = UDim2.new(0, 50, 0, 50)
    BToggleFrame.Active = true
    BToggleFrame.Draggable = true

    local BToggleCorner = Instance.new("UICorner")
    BToggleCorner.CornerRadius = UDim.new(1, 0)
    BToggleCorner.Parent = BToggleFrame

    local BToggleStroke = Instance.new("UIStroke")
    BToggleStroke.Color = Color3.fromRGB(160, 0, 255)
    BToggleStroke.Thickness = 2
    BToggleStroke.Parent = BToggleFrame

    local BToggleImg = Instance.new("ImageLabel")
    BToggleImg.Parent = BToggleFrame
    BToggleImg.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    BToggleBtn.BackgroundTransparency = 1
    BToggleBtn.Size = UDim2.new(1, 0, 1, 0)
    BToggleBtn.Font = Enum.Font.SourceSans
    BToggleBtn.Text = ""

    local BTweenService = game:GetService("TweenService")
    local BZoomedIn = false
    local BTweenInfo = TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    ...
    -- Update stats loop
    task.spawn(function()
        local plrData = game:GetService("Players").LocalPlayer
        while task.wait(1) do
            pcall(function()
                local data = plrData:WaitForChild("Data")
                BLevelLabel.Text = "Level: " .. tostring(data:WaitForChild("Level").Value) .. "    Third Sea: " .. (data:WaitForChild("Level").Value >= 1500 and "✅" or "❌")
                BBeliLabel.Text = "Beli: " .. tostring(data:WaitForChild("Beli").Value)
                BRaceLabel.Text = "Race: " .. tostring(data:WaitForChild("Race").Value)
                BTL6.Text = "Frag: " .. tostring(data:WaitForChild("Fragments").Value)
            end)
        end
    end)

    -- Status updater (integra com o script principal)
    _G.TRonStatusLabel = BStatusTop
    _G.TRonFarmLabel = BStatusFarm
end)
